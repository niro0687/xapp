...
class XSettings {
	...
	static filesFormats = ["mp3", "mp4", "wav", "py", "7z", "zip", "java", "js", "css", "html", "xml", "iso", "mov", "txt", "xlsx", "xls", "m4a", "rar",
		...
		"gif", "webm", "webp", "xhtml", "word", "avi", "pyc", "svg", "csv", "sql"
	];
...
class XNi {
	...
	xAlert(title, message, status, x=false) {
		...
		if (this.popupFrame == null) {
			this.popupFrame = this.createElement("div", "x-app-popup", "x-popup-frame x-popup-hidden x-frame-fullscreen");
			this.containerPopup = this.createElement("div", null, "x-container-alert x-pos-rel x-rd-20 x-overf-hidden");
			this.topStyle = this.createElement("div", null, "x-frame-top-style");
			this.span = document.createElement("span");
			this.titleAlert = this.createElement("p", "title", "x-te-al_ce x-fo-we_bo x-alert-title");
			this.message = this.createElement("p", "message", "x-te-al_ce x-alert-message");
			this.ok = this.createElement("div", "ok", null);
			this.okText = this.createElement("button", null, null);
